...
# Jeronix only (owner's decision 2026-08-06): the full console carries one showcase account,
# so it matches the public build in everything but that account's data.
USERS = ['Jeronix']
